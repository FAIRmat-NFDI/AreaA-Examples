...
After you create an upload, we will create an entry using Experiment ELN. Within this
ELN, we will reference the sintering (Process) and XRD (Measurement) steps. Each of the
step will be an individual entry in the upload folder, and will be connected to the 
Experiment ELN via references.
...
example of using references to create semantic connections between entries: sample is 
